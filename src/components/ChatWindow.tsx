    ...
    <div style={{
      ...
      <aside style={{
        ...
        <div style={{ display:'flex', alignItems:'center', gap:'10px', marginBottom:'24px', paddingLeft:'4px' }}>
          ...
          {isMobile && (
            <button
              onClick={() => setSidebarOpen(false)}
              style={{ background:'none', border:'none', color:'#6b6b80', fontSize:'22px', cursor:'pointer', padding:'0 4px', lineHeight:1 }}
            >✕</button>
          )}
        </div>
      ...
      <main style={{
        ...
        <header style={{
          ...
          {/* Hamburger — always rendered, shown only on mobile */}
          <button
            onClick={() => setSidebarOpen(true)}
            style={{
              background:'none', border:'none', color:'#e8e8f0',
              fontSize:'22px', cursor:'pointer', padding:'4px',
              lineHeight:1, display: isMobile ? 'flex' : 'none',
